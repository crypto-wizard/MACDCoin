...
static const int64 MAX_MONEY = 48000000 * COIN;			// 12 Mil & overhead
static const int64 CIRCULATION_MONEY = MAX_MONEY;
static const double TAX_PERCENTAGE = 0.00;
static const int64 MAX_MACD_PROOF_OF_STAKE = 0.12 * COIN;    // 12% annual interest
...
static const uint256 hashGenesisBlockOfficial("b5af7ae41e04071321aac1135747ef7f216b310f46e7f090506f062b150932ba");
static const uint256 hashGenesisBlockTestNet ("b5af7ae41e04071321aac1135747ef7f216b310f46e7f090506f062b150932ba");
...
public:
    ...
    {
        // MACDCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // MACDCoin: get transaction coin age
...
public:
    ...
    // MACDCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // MACDCoin: entropy bit for stake modifier if chosen by modifier
    ...
    // MACDCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // MACDCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // MACDCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // MACDCoin: trust score of block chain
    int nHeight;

    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // MACDCoin: block index flags
    enum  
    {
